...
export const MOCK_DATA: { transactions: Transaction[]} = {
  transactions: [
    { id: "1", type: "expense", amount: 45, description: "กาแฟเย็น Cafe Amazon", date: "2024-01-15T08:30:00Z" },
    { id: "2", type: "expense", amount: 350, description: "เติมน้ำมัน Shell", date: "2024-01-15T12:00:00Z"},
    ...
    { id: "9", type: "expense", amount: 890, description: "ค่ารักษาพยาบาล", date: "2024-01-12T10:30:00Z"},
